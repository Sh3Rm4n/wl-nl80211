...
impl Nl80211InterfaceSetRequest {
    ...
    ) -> impl TryStream<Ok = GenlMessage<Nl80211Message>, Error = Nl80211Error>
    {
        ...
        let nl80211_msg = Nl80211Message {
            ...
            // TODO: Should this be open to every attribute or restricted to Interface ATTR?
            attributes: dbg!(attributes),
        };
        // TODO: is the in iw dev set
        // I don't understand the correct seting of flags yet. In case of set `iw` does
        // not set any flag, but here NLM_F_REQUEST is always set. Curentliy infreadead.org libnl
        // documentation website is down.
        // These are the same flags as in scan.rs
